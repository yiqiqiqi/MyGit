...
export default function ZhihuiMenPage() {
    ...
    <Layout title="EEnous - 智慧门·人工智能宗">
      <SectAuth 
        ...
        renderContent={(user, logout, updateFunctions) => {
          ...
          return (
          <div className="sect-page zhihui-sect">
            <div className="sect-container">
              ...
              <div className="sect-header">
                <div className="sect-emblem">智</div>
                <h1 className="sect-title">智慧门</h1>
                <p className="sect-subtitle">人工智能宗</p>
                <div className="sect-slogan">智慧明珠·人工智能术</div>
              </div>
                ...
                <div className="cultivation-content">
                  ...
                  <div className="course-list">
                    ...
                    <div className="course-item">
                      ...
                      <div className="course-info">
                        <h4>深度学习模型开发</h4>
                        <p>掌握CNN、RNN、Transformer等深度学习架构</p>
                        <span className="course-status">即将开放</span>
                      </div>
                    </div>
                  ...
                  <div className="profile-grid">
                    ...
                    <div className="profile-card">
                      ...
                      <div className="info-grid">
                        <div className="info-item">
                          <label>当前门派</label>
                          <span className="sect-badge">智慧门</span>
                        </div>
                        <div className="info-item">
                          <label>修炼境界</label>
                      ...
                      <div className="sects-list">
                        {user.registeredSects && user.registeredSects.map(sid => (
                          <div key={sid} className="sect-item">
                            <span className="sect-name">{sid === 'zhihui' ? '智慧门' : sid}</span>
                            <button 
