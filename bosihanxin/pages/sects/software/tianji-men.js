...
export default function TianjiMenPage() {
    ...
    <Layout title="EEnous - 天机门·算法天机宗">
      <SectAuth 
        ...
        renderContent={(user, logout, updateFunctions) => {
          ...
          return (
          <div className="sect-page tianji-sect">
            <div className="sect-container">
              ...
              <div className="sect-header">
                <div className="sect-emblem">算</div>
                <h1 className="sect-title">天机门</h1>
                <p className="sect-subtitle">算法天机宗</p>
                <div className="sect-slogan">天机宝鉴·天机算法术</div>
              </div>
                  ...
                  <div className="profile-grid">
                    ...
                    <div className="profile-card">
                      ...
                      <div className="info-grid">
                        <div className="info-item">
                          <label>当前门派</label>
                          <span className="sect-badge">天机门</span>
                        </div>
                        <div className="info-item">
                          <label>修炼境界</label>
                      ...
                      <div className="sects-list">
                        {user.registeredSects && user.registeredSects.map(sid => (
                          <div key={sid} className="sect-item">
                            <span className="sect-name">{sid === 'tianji' ? '天机门' : sid}</span>
                            <button 
            ...
            <style jsx>{`
              .sect-page {
                min-height: 100vh;
                background: linear-gradient(135deg, #000000 0%, #1a0a2a 50%, #2a1a3a 100%);
                color: #ffffff;
                position: relative;
              }
