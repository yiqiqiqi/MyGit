...
export default function HuanxiangMenPage() {
    ...
    <Layout title="EEnous - 幻象门·用户体验宗">
      <SectAuth 
        ...
        renderContent={(user, logout, updateFunctions) => {
          ...
          return (
          <div className="sect-page huanxiang-sect">
            <div className="sect-container">
              ...
              <div className="sect-header">
                <div className="sect-emblem">幻</div>
                <h1 className="sect-title">幻象门</h1>
                <p className="sect-subtitle">用户体验宗</p>
                <div className="sect-slogan">体验神瞳·用户幻象术</div>
              </div>
                  ...
                  <div className="profile-grid">
                    ...
                    <div className="profile-card">
                      ...
                      <div className="info-grid">
                        <div className="info-item">
                          <label>当前门派</label>
                          <span className="sect-badge">幻象门</span>
                        </div>
                        <div className="info-item">
                          <label>修炼境界</label>
                      ...
                      <div className="sects-list">
                        {user.registeredSects && user.registeredSects.map(sid => (
                          <div key={sid} className="sect-item">
                            <span className="sect-name">{sid === 'huanxiang' ? '幻象门' : sid}</span>
                            <button 
