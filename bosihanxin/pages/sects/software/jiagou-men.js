...
export default function JiagouMenPage() {
    ...
    <Layout title="EEnous - 架构门·系统设计宗">
      <SectAuth 
        ...
        renderContent={(user, logout, updateFunctions) => {
          ...
          return (
          <div className="sect-page jiagou-sect">
            <div className="sect-container">
              ...
              <div className="sect-header">
                <div className="sect-emblem">构</div>
                <h1 className="sect-title">架构门</h1>
                <p className="sect-subtitle">系统设计宗</p>
                <div className="sect-slogan">架构神图·系统设计术</div>
              </div>
                  ...
                  <div className="profile-grid">
                    ...
                    <div className="profile-card">
                      ...
                      <div className="info-grid">
                        <div className="info-item">
                          <label>当前门派</label>
                          <span className="sect-badge">架构门</span>
                        </div>
                        <div className="info-item">
                          <label>修炼境界</label>
                      ...
                      <div className="sects-list">
                        {user.registeredSects && user.registeredSects.map(sid => (
                          <div key={sid} className="sect-item">
                            <span className="sect-name">{sid === 'jiagou' ? '架构门' : sid}</span>
                            <button 
            ...
            <style jsx>{`
              .sect-page {
                min-height: 100vh;
                background: linear-gradient(135deg, #000000 0%, #1a1a0a 50%, #2a2a1a 100%);
                color: #ffffff;
                position: relative;
              }
