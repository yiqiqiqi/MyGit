...
export default function RongheMenPage() {
    ...
    <Layout title="EEnous - 融合门·万法归宗派">
      <SectAuth 
        ...
        renderContent={(user, logout, updateFunctions) => {
          ...
          return (
          <div className="sect-page ronghe-sect">
            <div className="sect-container">
              ...
              <div className="sect-header">
                <div className="sect-emblem">合</div>
                <h1 className="sect-title">融合门</h1>
                <p className="sect-subtitle">万法归宗派</p>
                <div className="sect-slogan">融合宝镜·万法归一术</div>
              </div>
                  ...
                  <div className="profile-grid">
                    ...
                    <div className="profile-card">
                      ...
                      <div className="info-grid">
                        <div className="info-item">
                          <label>当前门派</label>
                          <span className="sect-badge">融合门</span>
                        </div>
                        <div className="info-item">
                          <label>修炼境界</label>
                      ...
                      <div className="sects-list">
                        {user.registeredSects && user.registeredSects.map(sid => (
                          <div key={sid} className="sect-item">
                            <span className="sect-name">{sid === 'ronghe' ? '融合门' : sid}</span>
                            <button 
            ...
            <style jsx>{`
              .sect-page {
                min-height: 100vh;
                background: linear-gradient(135deg, #000000 0%, #2a0a2a 50%, #3a1a3a 100%);
                color: #ffffff;
                position: relative;
              }
