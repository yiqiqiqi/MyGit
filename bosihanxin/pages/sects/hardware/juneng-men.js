...
export default function JunengMenPage() {
    ...
    <Layout title="EEnous - 聚能门·天地储能宗">
      <SectAuth 
        ...
        renderContent={(user, logout, updateFunctions) => {
          ...
          return (
          <div className="sect-page juneng-sect">
            <div className="sect-container">
              ...
              <div className="sect-header">
                <div className="sect-emblem">能</div>
                <h1 className="sect-title">聚能门</h1>
                <p className="sect-subtitle">天地储能宗</p>
                <div className="sect-slogan">聚能神丹·天地聚能术</div>
              </div>
                  ...
                  <div className="profile-grid">
                    ...
                    <div className="profile-card">
                      ...
                      <div className="info-grid">
                        <div className="info-item">
                          <label>当前门派</label>
                          <span className="sect-badge">聚能门</span>
                        </div>
                        <div className="info-item">
                          <label>修炼境界</label>
                      ...
                      <div className="sects-list">
                        {user.registeredSects && user.registeredSects.map(sid => (
                          <div key={sid} className="sect-item">
                            <span className="sect-name">{sid === 'juneng' ? '聚能门' : sid}</span>
                            <button 
            ...
            <style jsx>{`
              .sect-page {
                min-height: 100vh;
                background: linear-gradient(135deg, #000000 0%, #2a2a0a 50%, #3a3a1a 100%);
                color: #ffffff;
                position: relative;
              }
